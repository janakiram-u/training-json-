        ...
        <form className='Registration' onSubmit={handleSubmit((event)=>{saveRegistrationData(event)})} >
          ...
          {errors.firstName && errors.firstName.type==="required"?<span className='text-danger'>Enter your first name</span>: 
            ...
            {...register('company',{required:true})}
             placeholder="ScreenName" id='company'></input>
           ...
           {errors && errors.state? <alert className="text-danger">Enter your state</alert>: ""}
            ...
            <div className='col-1 m-2'>
                ...
                <div className='col-4'>
                <label>
                    <input type='checkbox'></input>I Agree to terms and conditions</label>
               
            </div>
            
                <div className='m-2'>
            
            <div className='col-2'><input type="submit" value="submit" className='submit-button' onClick={saveRegistrationData}
              />  <button className='btn btn-success'>cancel</button></div>
